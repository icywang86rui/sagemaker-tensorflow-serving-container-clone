 ...
 * Add docker-login
 * Add caching to build-all script
 * use pytest to run the integ tests
 * Always run local cpu tests
 * only have cpu local tests
 * Fix yaml file
 * Add release build spec and add build and publish scripts
